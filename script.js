...
var winWidth = cote_gauche.clientWidth;
var winHeight = cote_gauche.clientHeight;
...
document.getElementById('bouton_principal').onmousemove = function clickEvent(e) {
    // e = Mouse click event.
    var rect = cote_gauche.getBoundingClientRect();
    x = e.clientX - rect.left - 28; //x position within the element.
    y = e.clientY - rect.top - 59;  //y position within the element.
    
  }

function billeterie(){
    var billets = document.getElementsByClassName("item")
